...
const tests: Record<string, Partial<ParsedVersionLevel>> = {
	'1.2.3': { major: 1, minor: 2, patch: 3, postfix: undefined, semverLevel: 'major' },
	'1.2': { major: 1, minor: 2, patch: 0, postfix: undefined, semverLevel: 'major' },
	...
	'v1.2.3': { major: 1, minor: 2, patch: 3, postfix: undefined, semverLevel: 'major' },
	'v1.2': { major: 1, minor: 2, patch: 0, postfix: undefined, semverLevel: 'major' },
